<link rel="stylesheet" href="/new/wp-content/themes/verve/thickbox.css" type="text/css" media="screen" />
...
<div id="shoutbox" class="sidebarBox">
        ...
        <div class="sidebarBoxTop" style="margin-top:10px"></div>
            <div class="sidebarBoxMiddle">
                <?php
                    if(!function_exists('dynamic_sidebar')|| !dynamic_sidebar('Archives Search')) {
                        print 'Widget home is broken';
                    }
                ?>
            </div>
